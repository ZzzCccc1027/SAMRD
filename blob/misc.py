...
# def overlay_contours(img: np.ndarray, mask: np.ndarray, color=(0, 255, 0), thickness=1):
#     """
#     img: RGB 图像，shape=(H, W, 3)
#     mask: 二值 mask，shape=(H, W)
#     """
#     img = img.copy()
#     assert img.ndim == 3 and img.shape[2] == 3, f"overlay_contours: img shape invalid: {img.shape}"
#     assert mask.ndim == 2, f"overlay_contours: mask shape invalid: {mask.shape}"
#
